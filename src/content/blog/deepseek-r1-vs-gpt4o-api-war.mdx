...
**ROI Result:** This hybrid strategy typically saves 85 percent on costs while maintaining Omni-level performance.
...
Yes, it supports up to 128k context, similar to GPT-4o. However, because R1 generates Thinking Tokens, you can hit the context limit faster if the model starts over-thinking a problem.
