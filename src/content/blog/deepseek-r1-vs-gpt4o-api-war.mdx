...
faq:
  ...
  - question: "Why is DeepSeek so much cheaper to run than GPT-4o?"
    answer: "They utilize an architecture called Mixture of Experts. Instead of activating the whole brain for every word, they only use the specific 5 to 10 percent of the model that is relevant to the question. This massive efficiency is passed on to the customer."
...
They utilize an architecture called Mixture of Experts. Instead of activating the whole brain for every word, they only use the specific 5 to 10 percent of the model that is relevant to the question. This massive efficiency is passed on to the customer.
